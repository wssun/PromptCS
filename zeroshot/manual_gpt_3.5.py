...
def read_examples(filename):
    ...
    with open(filename,encoding="utf-8") as f:
        for idx, line in enumerate(f):
            ...
            query = "Please generate a short comment in one sentence for the following function:\n" + code
...
if __name__ == "__main__":
    ...
    ## Required parameters
    parser.add_argument("--output_dir", default='./saved_manual_gpt_3.5_result', type=str,
